...
class DocsController < ApplicationController
  ...
  def gem_views
    prefix = "#{RecordingStudio::WebReader::Engine.root}/"

    @engine_views = Dir.glob(RecordingStudio::WebReader::Engine.root.join("app/views/recording_studio_web_reader/**/*.erb").to_s)
      .sort
